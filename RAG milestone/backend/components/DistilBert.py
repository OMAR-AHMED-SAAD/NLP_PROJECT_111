...
class DistilBert:
    ...
    '''
    def __init__(self, 
                 tokenizer_path: str = "../distilbert-squad-finetuned_tokenizer/distilbert-squad-finetuned_tokenizer", 
                 model_path: str = "../distilbert-squad-finetuned_model/distilbert-squad-finetuned_model",
    ...
    def answer_question(
        ...
        with torch.no_grad():
            outputs = self.model(**inputs) # Changed model to self.model
